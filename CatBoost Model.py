...
#   Shimmer:APQ5, MDVP:APQ, Shimmer:DDA, NHR, HNR, status, RPDE, DFA, spread1, spread2, D2, PPE
#
...
# 4. Create and train the CatBoost model
# You can tune parameters such as depth, iterations, learning_rate, etc.
model = CatBoostClassifier(
    iterations=500,
    learning_rate=0.1,
    depth=4,
    verbose=False,  # Set to True to see training info
    random_seed=42
)
